  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setAnimatedStats(prev => ({
        ...prev,
        totalSupply: Math.min(prev.totalSupply + 5000, 1000000),
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <motion.div variants={countUp} className="relative">
              ...
              <div className="bg-neutral-900/80 rounded-2xl p-6 relative h-full">
                <p className="text-4xl font-light mb-2">{(animatedStats.totalSupply / 1000000).toFixed(1)}M</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="bg-neutral-900/80 rounded-2xl p-6 relative h-full">
                ...
                <h3 className="text-xl font-medium mb-3">Приоритетный доступ</h3>
                <p className="text-sm text-gray-300">
                  Эксклюзивный ранний доступ к новым функциям платформы, партнерским программам и 
                  специальным мероприятиям с представителями приютов.
                </p>
              </div>
            </motion.div>
